<template>
	<view :style='{"alignContent":"flex-start","width":"100%","padding":"20rpx","flexWrap":"wrap","background":"#fff3e8","display":"flex"}'>
		...
		<swiper :style='{"width":"100%","borderRadius":"20rpx 20rpx 0 0","background":"none","height":"360rpx"}' class="swiper" :indicator-dots='false' :autoplay='false' :circular='false' indicator-active-color='#000000' indicator-color='rgba(0, 0, 0, .3)' :duration='500' :interval='5000' :vertical='false'>
			<swiper-item :style='{"width":"100%","background":"none","height":"360rpx"}' v-for="(swiper,index) in swiperList" :key="index">
				<image :style='{"width":"100%","objectFit":"cover","borderRadius":"20rpx 20rpx 0 0","display":"block","height":"360rpx"}' mode="aspectFill" v-if="swiper.substring(0,4)=='http'" :src="swiper" @tap="imgView2(swiper)"></image>
				<image :style='{"width":"100%","objectFit":"cover","borderRadius":"20rpx 20rpx 0 0","display":"block","height":"360rpx"}' mode="aspectFill" v-else :src="baseUrl+swiper" @tap="imgView2(baseUrl+swiper)"></image>
			</swiper-item>
		</swiper>
		<view :style='{"margin":"0px auto 0","borderRadius":"0px 0px 0 0","color":"#333","textAlign":"center","background":"#fff","width":"calc(100% - 0px)","fontSize":"32rpx","lineHeight":"88rpx"}'>
			{{forum.title}}
		</view>
		<view :style='{"padding":"0 24rpx 12rpx","margin":"0 auto","borderColor":"#ddd","color":"#888","textAlign":"center","background":"#fff","borderWidth":"0 0 2rpx","width":"calc(100% - 2rpx)","fontSize":"28rpx","borderStyle":"solid"}'>
			<span class="icon iconfont icon-touxiang18" :style='{"padding":"0 20rpx 0 0","display":"none"}'></span>
		...
		<view class="operateView" :style='{"padding":"24rpx 24rpx 48rpx","margin":"0 auto 0","alignItems":"center","borderRadius":"0 0 20rpx 20rpx","background":"#fff","display":"flex","width":"calc(100% - 0px)","fontSize":"30rpx","order":"2"}'>
			<view v-if="!likeType" :style='{"padding":"10rpx 50rpx","margin":"0 0px 0 0","color":"#666","borderRadius":"40rpx 0 0 40rpx","textAlign":"center","background":"#ffe8d0","width":"50%"}' @click="likeClick">
			...
			<view v-if="!collectType" :style='{"width":"50%","padding":"10rpx 50rpx","color":"#666","borderRadius":"0 40rpx 40rpx 0","textAlign":"center","background":"#f0f0f0"}' @click="collectClick">
		...
		<view :style='{"border":"0px solid #eee","padding":"24rpx 24rpx","margin":"0 auto","color":"#666","background":"#fff","width":"calc(100% - 0px)","fontSize":"30rpx","lineHeight":"48rpx"}'>
			<rich-text :nodes="forum.content"></rich-text>
		</view>
		<view :style='{"width":"calc(100% - 0px)","margin":"40rpx auto 168rpx","background":"none","order":"11"}'>
			<view :style='{"width":"100%","padding":"48rpx 24rpx 48rpx","margin":"0 0 40rpx","borderRadius":"20rpx","background":"#fff"}' v-for="comment in commentData" :key="comment.id">
				<view :style='{"padding":"20rpx","alignItems":"center","color":"#ccc","justifyContent":"flex-start","display":"flex"}'>
					<image class="image" :src="baseUrl+comment.avatarurl" mode="widthFix" :style='{"borderRadius":"100%","width":"76rpx","height":"76rpx"}'></image>
					<view :style='{"padding":"0 0 0 20rpx","flexDirection":"row","display":"flex","width":"100%","fontSize":"28rpx","lineHeight":"1","justifyContent":"space-between"}'>
						<view :style='{"color":"#000","lineHeight":"2","fontSize":"28rpx"}'>
							{{comment.username}}
						</view>
						<view :style='{"lineHeight":"2","fontSize":"28rpx"}'> {{comment.addtime.split(' ')[0]}}</view>
					</view>
				</view>
				<view :style='{"padding":"0 20rpx 20rpx 100rpx","borderColor":"#fa861c","fontSize":"28rpx","color":"#333","borderStyle":"solid","borderWidth":"0 0 2rpx"}'>
					...
					<view :style='{"width":"100%","alignItems":"center","justifyContent":"flex-end","display":"flex"}'>
						<text @tap="onReplyTap(comment.id)" :style='{"padding":"6rpx 20rpx","margin":"0 0px 0 0","color":"#fff","borderRadius":"4rpx","background":"#fa861c","order":"2"}'>回复</text>
						<text @tap="delClick(comment.id)" v-if="userid==comment.userid" :style='{"border":"2rpx solid #ccc","padding":"4rpx 20rpx","margin":"0 20rpx 0 0","color":"#666","borderRadius":"4rpx","background":"#ededed"}'>删除</text>
					</view>
				</view>
				<view :style='{"width":"100%","padding":"0 0 0 80rpx"}' v-if="comment.childs">
					<view :style='{"width":"100%"}' v-for="item in comment.childs" :key="item.id">
						...
						<view :style='{"padding":"0 20rpx 20rpx 100rpx","borderColor":"#fa861c","color":"#333","background":"#fff","borderWidth":"0 0 2rpx","fontSize":"28rpx","borderStyle":"solid"}'>
							<rich-text :style='{"color":"#000"}' :nodes="item.content"></rich-text>
							<view :style='{"width":"100%","alignItems":"center","justifyContent":"flex-end","display":"flex"}'>
								<text :style='{"border":"2rpx solid #ccc","padding":"4rpx 20rpx","color":"#666","borderRadius":"4rpx","background":"#ededed"}' @tap="delClick(item.id)" v-if="userid==item.userid">删除</text>
							</view>
						</view>
					</view>
				</view>
