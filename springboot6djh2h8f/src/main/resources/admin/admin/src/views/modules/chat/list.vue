<template>
	<div class="main-content" :style='{"width":"calc(100% - 0px)","padding":"20px 30px 40px","margin":"0 auto","fontSize":"15px","background":"none"}'>
		...
		<div v-if="!showFlag" style="width: 100%;">
			<el-form :style='{"padding":"10px 0","margin":"0 0px 0px","alignItems":"center","flexWrap":"wrap","background":"none","display":"flex"}' :inline="true" :model="searchForm" class="center-form-pv">
				<el-row :style='{"width":"auto","padding":"0","alignItems":"center","flexWrap":"wrap","background":"none","display":"flex"}'>
					...
					<el-button class="search" :style='{"border":"0","cursor":"pointer","padding":"0 10px","color":"#fff","borderRadius":"4px","background":"#ff5f32","width":"auto","fontSize":"16px","height":"34px"}' type="success" @click="search()">
				...
				<el-table
					...
					<el-table-column
						...
						<template slot-scope="scope">
							<el-button
								type="text"
								:style='{"border":"0px solid #fed14e","cursor":"pointer","padding":"0 10px 5px","margin":"0 5px 5px 0","color":"#000","borderRadius":"4px","background":"url(http://codegen.caihongy.cn/20241013/f33cb7d49aab4bc3ab216deed4d04de7.png) no-repeat center top / 100% 100%","width":"auto","fontSize":"14px","height":"34px"}'
								size="small"
