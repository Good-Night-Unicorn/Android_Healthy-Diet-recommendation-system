			...
			<el-form class="center-form-pv" :style='{"padding":"10px 0","margin":"0 0px 0px","alignItems":"center","flexWrap":"wrap","background":"none","display":"flex"}' :inline="true" :model="searchForm">
				<el-row :style='{"width":"auto","padding":"0","alignItems":"center","flexWrap":"wrap","background":"none","display":"flex"}' >
					<div :style='{"alignItems":"center","margin":"0 10px 0 0","display":"flex"}'>
						<label :style='{"margin":"0 10px 0 0","whiteSpace":"nowrap","color":"#666","display":"inline-block","lineHeight":"40px","fontSize":"inherit","fontWeight":"500","height":"40px"}' class="item-label">记录标题</label>
						<el-input v-model="searchForm.jilubiaoti" placeholder="记录标题" @keydown.enter.native="search()" clearable></el-input>
					</div>
					<div :style='{"alignItems":"center","margin":"0 10px 0 0","display":"flex"}' class="select" label="记录类型" prop="jiluleixing">
						<label :style='{"margin":"0 10px 0 0","whiteSpace":"nowrap","color":"#666","display":"inline-block","lineHeight":"40px","fontSize":"inherit","fontWeight":"500","height":"40px"}' class="item-label">记录类型</label>
						<el-select clearable v-model="searchForm.jiluleixing" placeholder="请选择记录类型" >
							<el-option v-for="(item,index) in jiluleixingOptions" v-bind:key="index" :label="item" :value="item"></el-option>
						</el-select>
					</div>
		...
		methods: {
			...
			getDataList() {
				...
				let params = {
 				...
 				if(this.searchForm.jilubiaoti!='' && this.searchForm.jilubiaoti!=undefined){
					params['jilubiaoti'] = '%' + this.searchForm.jilubiaoti + '%'
				}
				if(this.searchForm.jiluleixing!='' && this.searchForm.jiluleixing!=undefined){
