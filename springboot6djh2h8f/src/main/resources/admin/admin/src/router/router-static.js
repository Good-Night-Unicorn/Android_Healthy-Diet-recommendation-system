...
import center from '@/views/center'
	...
	import jiankangshipu from '@/views/modules/jiankangshipu/list'
	import storeup from '@/views/modules/storeup/list'
	import forum from '@/views/modules/forum/list'
	import forumtype from '@/views/modules/forumtype/list'
	import yonghu from '@/views/modules/yonghu/list'
	import chat from '@/views/modules/chat/list'
	import shiyirenqun from '@/views/modules/shiyirenqun/list'
	import discussjiankangshipu from '@/views/modules/discussjiankangshipu/list'
